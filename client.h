...
struct ListACLsResponse : public Response
{
...
*/
    ...
    Response UpdateACL(const std::string& project, const ACL& acl);
    Response UpdateACL(const std::string& project, const std::string& logStore, const ACL& acl);
    ListACLsResponse ListACLs(const std::string& project, const int32_t& offset = -1, const int32_t& size = -1);
    ListACLsResponse ListACLs(const std::string& project, const std::string& logStore, const int32_t& offset = -1, const int32_t& size = -1);
